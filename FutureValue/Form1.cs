    ...
    public partial class Form1 : Form
    {
        ...
        public bool IsValidData()
        {
            return
                ...
                IsPresent(txtInterestRate, "Yearly Investment") &&
                IsDecimal(txtInterestRate, "Yearly Investment") &&
                IsWithinRange(txtInterestRate, "Yearly Investment", 1, 20) &&
        ...
        public bool IsDecimal(TextBox textBox, string name)
        {
            ...
            {
                MessageBox.Show(name + " must me a decimal value.", "Entry Error");
                textBox.Focus();
                return false;
            }
        }
        public bool IsInt32(TextBox textBox, string name)
        {
            ...
            {
                MessageBox.Show(name + " must me an interger.", "Entry Error");
                textBox.Focus();
                return false;
            }
        }
